...
class ESGMonitor:
        ...
        try:
            ...
            for entry in feed.entries[:20]:
                ...
                if has_enforcement and has_esg:
                    # Block marketing/commentary phrases (VERY STRICT)
                    is_commentary = any(phrase in combined for phrase in [
                        'what companies need to know', 'what employers need to know',
                        'what employers should know', 'what businesses should know',
                        'what companies should know',
                        'countdown to', 'guide to', 'how to', 'prepare for',
                        'here are the', 'day 1', 'signed day 1',
                        'laboremploymentlawblog.com', 'sheppard, mullin'
                    ])
    ...
    def run(self):
        ...
        # Targeted news searches for items missed by official feeds
        new_regulations.extend(self.check_targeted_news())
