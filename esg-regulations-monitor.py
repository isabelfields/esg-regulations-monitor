...
class RegulationMonitor:
    ...
    def check_dei_news(self):
        """Monitor Reuters for DEI enforcement and regulatory developments"""
        print("Checking Reuters for DEI enforcement...")
        new_items = []
        
        # Reuters feeds - professional legal/business news only
        reuters_feeds = [
